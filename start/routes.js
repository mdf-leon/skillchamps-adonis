...
Route.get('/managedHistoryList', 'ManageEventController.managedHistoryList').middleware('auth') // history para institute
...
Route.get('/managedPenaltyConfsFromTrial3', 'ManageEventController.managedPenaltyConfsFromTrial3')
Route.get('/managedBonusConfsFromTrial2/:user_id', 'ManageEventController.managedBonusConfsFromTrial2')
Route.get('/managedBonusConfsFromTrial3', 'ManageEventController.managedBonusConfsFromTrial3')
...
Route.post('/createTrialBracket', 'ManageEventController.createTrialBracket').middleware('auth')
Route.delete('/trial/:trial_id', 'ManageEventController.deleteTrial').middleware('auth') 
